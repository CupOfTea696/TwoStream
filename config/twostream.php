 ...
 *--------------------------------------------------------------------------
 *
 * All settings indicated by @optional can be removed from
 * this file if you don't want to override the default settings.
 *
 */
...
return [
    ...
    'push' => [
         ...
         *--------------------------------------------------------------------------
         *
         * TwoStream gives you the possibility to easily push messages to
         * subscribed Topics. To be able to push messages, you need to enable the
